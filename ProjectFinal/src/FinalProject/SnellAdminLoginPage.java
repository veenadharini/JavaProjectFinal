 ...
 * @author maher
 */
public class SnellAdminLoginPage extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame1
     */
    Connection con;
    public SnellAdminLoginPage() {
        initComponents();
    }
    ...
    private void logInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logInActionPerformed
        ...
        try{
            ...
            String StudentSql = ("Select username, password from snell_admin_info");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SnellAdminLoginPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
