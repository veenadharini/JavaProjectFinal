...
import static FinalProject.StudentReservationsPage.dateField;
import static FinalProject.StudentReservationsPage.floorField;
import static FinalProject.StudentReservationsPage.nameField;
import static FinalProject.StudentReservationsPage.statusField;
import static FinalProject.StudentReservationsPage.timingField;
...
public class StudentReservationsQRScanner extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public StudentReservationsQRScanner() {
        initComponents();
        initWebcam();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SCAN THE QR CODE TO COMPLETE CHECK-IN ");
    ...
    private void checkInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkInButtonActionPerformed
        ...
        String seat = StudentReservationsPage.nameField.getText();
        String timing = StudentReservationsPage.timingField.getText();
        String date = StudentReservationsPage.dateField.getText();

        String success = "check-in successful";
        ...
        try {
            ...
            String slotSql = ("Select code from slot_info where username = '"+username+"' and seat_name = '"+seat+"' and time = '"+timing+"' and date = '"+date+"'  " );
           ...
           if (code.equals(value)) {
            ...
            String update = ("UPDATE slot_info SET status = '"+success+"' where username = '"+username+"' and seat_name = '"+seat+"' and time = '"+timing+"' and date = '"+date+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentReservationsQRScanner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
